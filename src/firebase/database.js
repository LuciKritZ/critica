...
var userBookRef = db.collection('user_books')
var userCommentAndRatingRef = db.collection('user_comments_rating')
var userCommentRelationRef = db.collection('user_comment_relation')
var userRole = db.collection('role')
...
export const doCreateUserComment = (userCommentaAndRating) => userCommentAndRatingRef.add(userCommentaAndRating)

//create user comment relation
export const doCreateUserCommentRelation = (userCommentRelation) => userCommentRelationRef.add(userCommentRelation)
...
export const doGetBookUsersByUserBookID = (userID,bookID) => userBookRef.where('userID',"==",userID).where('bookID',"==",bookID)
...
export const doGetUserCommentAndRating = (commentID) => userCommentAndRatingRef.where('commentID',"==",commentID)

//get/read user book comment realtion
export const doGetUserCommentRelation = (userID,bookID) => userCommentRelationRef.where('userID',"==",userID).where('bookID',"==",bookID)
